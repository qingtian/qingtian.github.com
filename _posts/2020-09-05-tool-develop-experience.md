...
我们常说的埋点就是指行为数据分析。行为数据分析的工具有很多，内部的有[哈勃](https://hubble.netease.com/)，外部有[GA](https://analytics.google.com/)，[百度统计](https://tongji.baidu.com/web/welcome/login)。

我比较偏爱GA，功能强大便捷，相对来说使用较久，对它所做的事也相对较了解。
